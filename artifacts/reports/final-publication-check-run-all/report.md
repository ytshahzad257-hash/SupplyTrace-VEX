...
Run ID: `final-publication-check-run-all`
...
> Evidence insufficiency warning: no scanner-confirmed findings were normalized. Do not claim prioritization improvement from this run.
...
- Risk score rows: 0
- Precision: 0.0 (not_available)
- Recall: 0.0 (not_available)
- F1: 0.0 (not_available)
- False-positive reduction: 0.0 (not_available)

Scores rank defensive actionability evidence. They do not prove exploitability.

## VEX Summary

- VEX-style record rows: 0
...
- Normalized findings available for evaluation: 0
- Paper-result claims supported: no
- Proposed MAP: 0.0 (not_available)
- Proposed NDCG: 0.0 (not_available)
- Evidence completeness mean: 0.0 (not_available)

## Baseline Comparison

| Method | Labeled | Top-5 | Top-10 | NDCG | MAP | Status |
| --- | --- | --- | --- | --- | --- | --- |
| cvss_only | 0 | 0.0 | 0.0 | 0.0 | 0.0 | not_available |
| direct_dependency_first | 0 | 0.0 | 0.0 | 0.0 | 0.0 | not_available |
| proposed_full_model | 0 | 0.0 | 0.0 | 0.0 | 0.0 | not_available |
| reachability_only | 0 | 0.0 | 0.0 | 0.0 | 0.0 | not_available |
| runtime_dependency_first | 0 | 0.0 | 0.0 | 0.0 | 0.0 | not_available |
| scanner_native_priority | 0 | 0.0 | 0.0 | 0.0 | 0.0 | not_available |
| severity_only | 0 | 0.0 | 0.0 | 0.0 | 0.0 | not_available |

## Ablation Study

| Variant | Top-5 | Top-10 | NDCG | MAP | Status |
| --- | --- | --- | --- | --- | --- |
| full_model | 0.0 | 0.0 | 0.0 | 0.0 | not_available |
| no_reachability | 0.0 | 0.0 | 0.0 | 0.0 | not_available |
| no_dependency_scope | 0.0 | 0.0 | 0.0 | 0.0 | not_available |
| no_scanner_agreement | 0.0 | 0.0 | 0.0 | 0.0 | not_available |
| severity_only | 0.0 | 0.0 | 0.0 | 0.0 | not_available |
| context_only | 0.0 | 0.0 | 0.0 | 0.0 | not_available |
