...
| --- | --- |
| skipped_not_applicable | 56 |
| success | 44 |
| unavailable | 150 |

| Scanner | Successful local runs |
| --- | --- |
| npm_audit | 23 |
| pip_audit | 21 |
...
- Normalized findings available for evaluation: 167
- Paper-result claims supported: review generated metrics before claiming
- Proposed MAP: 0.458853 (ok)
- Proposed NDCG: 0.767359 (ok)
- Evidence completeness mean: 0.822355 (ok)

## Baseline Comparison

The proposed contextual model did not outperform the reachability-only baseline in this run; claims must be limited to evidence-backed observations.

| Method | Labeled | Top-5 | Top-10 | NDCG | MAP | Status |
| --- | --- | --- | --- | --- | --- | --- |
| cvss_only | 143 | 0.0 | 0.0 | 0.720119 | 0.418589 | ok |
| direct_dependency_first | 143 | 0.2 | 0.2 | 0.710429 | 0.351517 | ok |
| proposed_full_model | 143 | 0.2 | 0.4 | 0.767359 | 0.458853 | ok |
| reachability_only | 143 | 0.2 | 0.4 | 0.781992 | 0.498147 | ok |
| runtime_dependency_first | 143 | 0.2 | 0.3 | 0.758405 | 0.456226 | ok |
| scanner_native_priority | 143 | 0.0 | 0.0 | 0.720119 | 0.418589 | ok |
| severity_only | 143 | 0.0 | 0.0 | 0.718792 | 0.41365 | ok |

## Ablation Study

| Variant | Top-5 | Top-10 | NDCG | MAP | Status |
| --- | --- | --- | --- | --- | --- |
| full_model | 0.2 | 0.4 | 0.767359 | 0.458853 | ok |
| no_reachability | 0.0 | 0.0 | 0.720119 | 0.418589 | ok |
| no_dependency_scope | 0.2 | 0.6 | 0.78358 | 0.488275 | ok |
| no_scanner_agreement | 0.2 | 0.6 | 0.78358 | 0.488275 | ok |
| severity_only | 0.0 | 0.0 | 0.720119 | 0.418589 | ok |
| context_only | 0.2 | 0.4 | 0.825735 | 0.670984 | ok |
